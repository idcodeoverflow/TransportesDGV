 ...
 * @author David Israel
 */
public class CargoOperadorExtemporaneo extends javax.swing.JFrame {
     ...
     */
    public CargoOperadorExtemporaneo() {
        try{
            initComponents();
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1287\n" + ex.getMessage(),
                    "Error al iniciar ventana Cargo a Operador!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("Constructor CargoOperadorExtemporaneo()", 1287, UserHome.getUsuario(), ex);
            this.dispose();
        }
    }
    ...
    public void mostrarInformacion(){
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1288\n" + ex.getMessage(),
                    "Error al mostrar los datos!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperadorExtemporaneo mostrarInformacion()", 1288, UserHome.getUsuario(), ex);
        }
    }
    ...
    public void setControlFacturasProveedor(ControlFacturasProveedor controlFacturas){
    ...
    private void initComponents() {
        ...
        setTitle("Cargo a Operador Extemporáneo - Sistema de Administración Mantenimiento");
        ...
        jLNumeroOperador.setText("# Operador:");
        ...
        jMenuItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/Search-16.png"))); // NOI18N
    ...
    private void jTFPrecioUnitarioCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTFPrecioUnitarioCaretUpdate
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1289\n" + ex.getMessage(),
                    "Error en el calculo de los valores!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperadorExtemporaneo jTFPrecioUnitarioCaretUpdate()", 1289, UserHome.getUsuario(), ex);
        }
    ...
    private void jTFCantidadCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTFCantidadCaretUpdate
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1290\n" + ex.getMessage(),
                    "Error en el calculo de los valores!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperadorExtemporaneo jTFCantidadCaretUpdate()", 1290, UserHome.getUsuario(), ex);
        }
    ...
    private void jTFSubtotalCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTFSubtotalCaretUpdate
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1291\n" + ex.getMessage(),
                    "Error en el calculo de los valores!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperadorExtemporaneo jTFSubtotalCaretUpdate()", 1291, UserHome.getUsuario(), ex);
        }
    ...
    private void jTFPorcentajeIVACaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTFPorcentajeIVACaretUpdate
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1292\n" + ex.getMessage(),
                    "Error en el calculo de los valores!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperadorExtemporaneo jTFPorcentajeIVACaretUpdate()", 1292, UserHome.getUsuario(), ex);
        }
    ...
    private void jTFIVACaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTFIVACaretUpdate
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1293\n" + ex.getMessage(),
                    "Error en el calculo de los valores!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperadorExtemporaneo jTFIVACaretUpdate()", 1293, UserHome.getUsuario(), ex);
        }
    ...
    public void agregar(){
        ...
        try{
            ...
            ordenReparacion = accesoReparacion.obtenerOrdenReparacion(numeroOrdenReparacion, true, true, true);//obtener numero de operador
            ...
            if(!agregarCargoOperadorExitoso && agregarCargoDirectoExitoso){
                ...
                if(reparacionExitosa){
                    JOptionPane.showMessageDialog(null, "Código error: 1294\n" + "No se pudo reparar la tabla",
                    "Error en acceso a datos!!!\nError al reparar la tabla.", JOptionPane.ERROR_MESSAGE);
                    ErrorLogger.scribirLog(cargoDirecto.toString(), 1294, UserHome.getUsuario(), new Exception("#NA"));
                }
            }
            ...
            if(!agregarCargoOperadorExitoso){
                ...
                if(!reparacionExitosa){
                    JOptionPane.showMessageDialog(null, "Código error: 1295\n" + "No se pudo reparar la tabla",
                    "Error en acceso a datos!!!\nError al reparar la tabla.", JOptionPane.ERROR_MESSAGE);
                    ErrorLogger.scribirLog(cargoOperador.toString(), 1295, UserHome.getUsuario(), new Exception("#NA"));
                } else {
            ...
            try {
                JOptionPane.showMessageDialog(null, "Código error: 1296\n" + ex.getMessage(),
                        "Error al guardar datos en la BD!!!", JOptionPane.ERROR_MESSAGE);
                ErrorLogger.scribirLog(cargoDirecto.toString() + cargoOperador.toString(), 1296, UserHome.getUsuario(), ex);
                boolean reparacionExitosa = false;
                CargoOperadorDAO accesoCargoOperador = new CargoOperadorDAO();
                reparacionExitosa = accesoCargoOperador.repararErrorAgregarCargoOperador();
                if(!reparacionExitosa){
                    JOptionPane.showMessageDialog(null, "Código error: 1297\n" + "No se pudo reparar la tabla",
                    "Error en acceso a datos!!!\nError al reparar la tabla.", JOptionPane.ERROR_MESSAGE);
                    ErrorLogger.scribirLog(cargoDirecto.toString() + cargoOperador.toString(), 1297, UserHome.getUsuario(), ex);
                } else {
                    JOptionPane.showMessageDialog(null, "Reparación exitosa!!!",
                    "La tabla se reparó correctamente.", JOptionPane.INFORMATION_MESSAGE);
                }
            } catch (SQLException ex1) {
                //Logger.getLogger(CargoOperador.class.getName()).log(Level.SEVERE, null, ex1);
            }
        } catch (Exception ex){
            try {
                JOptionPane.showMessageDialog(null, "Código error: 1298\n" + ex.getMessage(),
                        "Error al obtener los datos!!!", JOptionPane.ERROR_MESSAGE);
                ErrorLogger.scribirLog(cargoDirecto.toString() + cargoOperador.toString(), 1298, UserHome.getUsuario(), ex);
                boolean reparacionExitosa = false;
                CargoOperadorDAO accesoCargoOperador = new CargoOperadorDAO();
                reparacionExitosa = accesoCargoOperador.repararErrorAgregarCargoOperador();
                if(!reparacionExitosa){
                    JOptionPane.showMessageDialog(null, "Código error: 1299\n" + "No se pudo reparar la tabla",
                    "Error en acceso a datos!!!\nError al reparar la tabla.", JOptionPane.ERROR_MESSAGE);
                    ErrorLogger.scribirLog(cargoDirecto.toString() + cargoOperador.toString(), 1299, UserHome.getUsuario(), ex);
                } else {
                    JOptionPane.showMessageDialog(null, "Reparación exitosa!!!",
                    "La tabla se reparó correctamente.", JOptionPane.INFORMATION_MESSAGE);
                }
    ...
    public void limpiar(){
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1300\n" + ex.getMessage(),
                    "Error al limpiar los datos!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperadorExtemporaneo limpiar()", 1300, UserHome.getUsuario(), ex);
        }
    }
    ...
    private void prepararCaptura(javax.swing.JTextField campo){
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1301\n" + ex.getMessage(),
                    "Error al obtener los datos!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperadorExtemporaneo prepararCaptura()", 1301, UserHome.getUsuario(), ex);
        }
    }
    ...
    private void obtenerOperador(){
        try{
            ...
            if(this.jTFOrdenReparacion != null && !"".equals(this.jTFOrdenReparacion.getText())){
                numeroReparacion = Integer.parseInt(this.jTFOrdenReparacion.getText());
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1302\n" + ex.getMessage(),
                    "Error al obtener datos de la BD!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperadorExtemporaneo obtenerOperador()", 1302, UserHome.getUsuario(), ex);
        } catch (Exception ex){
            JOptionPane.showMessageDialog(null, "Código error: 1303\n" + ex.getMessage(),
                    "Error al convertir los datos!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperadorExtemporaneo obtenerOperador()", 1303, UserHome.getUsuario(), ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargoOperadorExtemporaneo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CargoOperadorExtemporaneo().setVisible(true);
            }
        });
    }
