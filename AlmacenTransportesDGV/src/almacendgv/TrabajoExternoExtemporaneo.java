...
public class TrabajoExternoExtemporaneo extends javax.swing.JFrame {
    ...
    private void jTFSubtotalCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTFSubtotalCaretUpdate
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1326\n" + ex.getMessage(),
                    "Error en el calculo de los valores!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("TrabajoExternoExtemporaneo jTFSubtotalCaretUpdate()", 1326, UserHome.getUsuario(), ex);
        }
    ...
    private void jTFPorcentajeIVACaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTFPorcentajeIVACaretUpdate
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1327\n" + ex.getMessage(),
                    "Error en el calculo de los valores!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("TrabajoExternoExtemporaneo jTFPorcentajeIVACaretUpdate()", 1327, UserHome.getUsuario(), ex);
        }
    ...
    private void jTFIVACaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTFIVACaretUpdate
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1328\n" + ex.getMessage(),
                    "Error en el calculo de los valores!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("TrabajoExternoExtemporaneo jTFIVACaretUpdate()", 1328, UserHome.getUsuario(), ex);
        }
