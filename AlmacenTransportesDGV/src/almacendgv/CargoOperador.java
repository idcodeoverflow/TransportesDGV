 ...
 * @author David Israel
 */
public class CargoOperador extends javax.swing.JFrame {
    ...
    public CargoOperador() {
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 737\n" + ex.getMessage(),
                    "Error al iniciar ventana Cargo a Operador!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("Constructor CargoOperador()", 737, UserHome.getUsuario(), ex);
            this.dispose();
        }
    }
    ...
    public void mostrarInformacion(){
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 738\n" + ex.getMessage(),
                    "Error al mostrar los datos!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperador mostrarInformacion()", 738, UserHome.getUsuario(), ex);
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("Cargo a Operador - Sistema de Administración Mantenimiento");
    ...
    private void jTFPrecioUnitarioCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTFPrecioUnitarioCaretUpdate
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 739\n" + ex.getMessage(),
                    "Error en el calculo de los valores!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperador jTFPrecioUnitarioCaretUpdate()", 739, UserHome.getUsuario(), ex);
        }
    ...
    private void jTFCantidadCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTFCantidadCaretUpdate
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 740\n" + ex.getMessage(),
                    "Error en el calculo de los valores!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperador jTFCantidadCaretUpdate()", 740, UserHome.getUsuario(), ex);
        }
    ...
    private void jTFSubtotalCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTFSubtotalCaretUpdate
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 741\n" + ex.getMessage(),
                    "Error en el calculo de los valores!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperador jTFSubtotalCaretUpdate()", 741, UserHome.getUsuario(), ex);
        }
    ...
    private void jTFPorcentajeIVACaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTFPorcentajeIVACaretUpdate
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 742\n" + ex.getMessage(),
                    "Error en el calculo de los valores!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperador jTFPorcentajeIVACaretUpdate()", 742, UserHome.getUsuario(), ex);
        }
    ...
    private void jTFIVACaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTFIVACaretUpdate
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 743\n" + ex.getMessage(),
                    "Error en el calculo de los valores!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperador jTFIVACaretUpdate()", 743, UserHome.getUsuario(), ex);
        }
    ...
    private void jCBOrdenReparacionFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jCBOrdenReparacionFocusLost
        try{
            ...
            if(index > -1){
                ...
                this.jTFNumeroOperador.setText(ordenReparacion.getOperador().getNombre() + " " + 
                        ordenReparacion.getOperador().getApellidos());
            }
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Código error: 744\n" + ex.getMessage(),
                    "Error al obtener datos de la BD!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperador jCBOrdenReparacionFocusLost()", 744, UserHome.getUsuario(), ex);
        } catch (Exception ex){
            JOptionPane.showMessageDialog(null, "Código error: 745\n" + ex.getMessage(),
                    "Error al convertir los datos!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperador jCBOrdenReparacionFocusLost()", 745, UserHome.getUsuario(), ex);
        }
    ...
    public void agregar(){
        ...
        try{
            ...
            ordenReparacion = accesoReparacion.obtenerOrdenReparacion(Integer.parseInt(this.jCBOrdenReparacion.
                    getSelectedItem().toString()), true, true, true);//obtener numero de operador
    ...
    public void limpiar(){
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 751\n" + ex.getMessage(),
                    "Error al limpiar los datos!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperador limpiar()", 751, UserHome.getUsuario(), ex);
        }
    }
    ...
    public void obtenerOrdenesReparacion(){
        try {
            ...
            JOptionPane.showMessageDialog(null, "Código error: 752\n" + ex.getMessage(),
                    "Error al obtener datos de la BD!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperador obtenerOrdenesReparacion()", 752, UserHome.getUsuario(), ex);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, "Código error: 753\n" + ex.getMessage(),
                    "Error al obtener los datos!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperador obtenerOrdenesReparacion()", 753, UserHome.getUsuario(), ex);
        }
    }
    ...
    private void prepararCaptura(javax.swing.JTextField campo){
        try{
            ...
            JOptionPane.showMessageDialog(null, "Código error: 754\n" + ex.getMessage(),
                    "Error al obtener los datos!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("CargoOperador prepararCaptura()", 754, UserHome.getUsuario(), ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargoOperador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CargoOperador().setVisible(true);
            }
        });
    }
