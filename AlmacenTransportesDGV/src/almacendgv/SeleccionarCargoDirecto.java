 ...
 * @author David Israel
 */
public class SeleccionarCargoDirecto extends javax.swing.JFrame {
     ...
     */
    public SeleccionarCargoDirecto() {
        try{
            initComponents();
            this.setLocationRelativeTo(null);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, "Código error: 1136\n" + ex.getMessage(),
                    "Error al iniciar ventana Cargo Directo!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("Constructor SeleccionarCargoDirecto()", 1136, UserHome.getUsuario(), ex);
            this.dispose();
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("Seleccionar Tipo de Cargo - Sistema de Administración Mantenimiento");
        setResizable(false);
    ...
    private void aceptar(){
        try{
            if(this.jCBTipoCargoDirecto.getSelectedIndex() == 0){
                CargoUnidad cargoUnidad = new CargoUnidad();
                ...
                CargoOperador cargoOperador = new CargoOperador();
                ...
                CargoEspecial cargoEspecial = new CargoEspecial();
            ...
            JOptionPane.showMessageDialog(null, "Código error: 1137\n" + ex.getMessage(),
                    "Error al abrir el cargo!!!", JOptionPane.ERROR_MESSAGE);
            ErrorLogger.scribirLog("SeleccionarCargoDirecto aceptar()", 1137, UserHome.getUsuario(), ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionarCargoDirecto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionarCargoDirecto().setVisible(true);
            }
        });
    }
